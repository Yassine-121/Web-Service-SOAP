 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://bws/", wsdlLocation = "http://localhost:8686/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://bws/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://bws/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://bws/", "BanqueServicePort"), BanqueService.class, features);
    }
