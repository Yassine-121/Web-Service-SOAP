...
public class ObjectFactory {
    ...
    private final static QName _ListComptes_QNAME = new QName("http://bws/", "listComptes");
    private final static QName _ListComptesResponse_QNAME = new QName("http://bws/", "listComptesResponse");
    private final static QName _GetCompte_QNAME = new QName("http://bws/", "getCompte");
    private final static QName _GetCompteResponse_QNAME = new QName("http://bws/", "getCompteResponse");
    private final static QName _ConversionEuroToDH_QNAME = new QName("http://bws/", "ConversionEuroToDH");
    private final static QName _ConversionEuroToDHResponse_QNAME = new QName("http://bws/", "ConversionEuroToDHResponse");
    private final static QName _Compte_QNAME = new QName("http://bws/", "compte");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: bws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bws/", name = "listComptes")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bws/", name = "listComptesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bws/", name = "getCompte")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bws/", name = "getCompteResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bws/", name = "ConversionEuroToDH")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bws/", name = "ConversionEuroToDHResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bws/", name = "compte")
